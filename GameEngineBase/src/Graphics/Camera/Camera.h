...
namespace gebase { namespace graphics {
	...
	public:
		...
		inline const math::Vector3f& getRotation() const { return m_Rotation; }
		inline void setRotation(const math::Vector3f& rotation) { m_Rotation = rotation; }
		...
		inline void Rotate(const math::Vector3f& rotation) { m_Rotation += rotation; }
		inline void Rotate(float x, float y, float z) { m_Rotation += math::Vector3f(x, y, z); }
	};
