...
namespace gebase { namespace graphics {
	...
	private:
		static std::vector<VertexArray*> s_CurrentVertexArray;
		static std::map<VertexArray*, VertexArray*> s_APIChangeMapVertexArray;
	public:
		static inline void AddRenderAPIChange(VertexArray* old, VertexArray* current) { s_APIChangeMapVertexArray.insert_or_assign(old, current); }
		static inline bool HasRenderAPIChange(VertexArray* old) { return s_APIChangeMapVertexArray.find(old) != s_APIChangeMapVertexArray.end(); }
		static inline VertexArray* GetRenderAPIChange(VertexArray* old) { return s_APIChangeMapVertexArray.at(old); }
