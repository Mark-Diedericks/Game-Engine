...
namespace gebase { namespace graphics {
	...
	APIContext* APIContext::s_PreviousContext = nullptr;
	...
	void APIContext::Create(WindowProperties properties, void* deviceContext)
	{
		...
		//case RenderAPI::VULKAN: s_Context = genew VKContext(properties, deviceContext); break;
		case RenderAPI::D3D11: s_Context = genew DX11Context(properties, deviceContext); break;
		//case RenderAPI::D3D12: s_Context = genew DX12Context(properties, deviceContext); break;
		}
	}
